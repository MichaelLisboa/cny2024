...
export const zodiacData = [
    {
        ...
        story: "Known for its grace and elegance, The Crane was initially part of the race. *element_endResult* *trait_noun*. *alliance_endResult* *path_endResult*. You took shelter during a rainstorm, *riddle_endResult*. *puzzle_endResult*. *calligraphy_endResult*. *spot_endResult*.",
